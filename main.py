...
stations_file = resource_path("stations.txt")
...
def load_stations():
    stations_file = resource_path("stations.txt")  # <- burda resource_path istifadə et
    try:
        with open(stations_file, "r", encoding="utf-8") as f:
            return json.load(f)
    except FileNotFoundError:
        return []  # Əgər fayl yoxdursa, boş siyahı qaytar
